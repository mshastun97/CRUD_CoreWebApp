...
namespace CRUD_CoreWebApp.API
{
    public class Startup
    {
        ...
        private static void ConfigureHealthChecks(IServiceCollection service)
        {
        ...
        private static void RegisterHealthChecks(IApplicationBuilder app)
        {
